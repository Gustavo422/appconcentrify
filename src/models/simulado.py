...
class Simulado(db.Model):
    ...
    # Relacionamentos
    questoes = db.relationship('Questao', backref='simulado', lazy=True, cascade='all, delete-orphan')
    
    def __init__(self, titulo, descricao=None, arquivo_json=None):
        self.titulo = titulo
...
class Questao(db.Model):
    ...
    def __init__(self, simulado_id, materia, enunciado, alternativa_a, alternativa_b, 
...
class RespostaSimulado(db.Model):
    __tablename__ = 'respostas_simulados'
    ...
    # Relacionamentos
    user = db.relationship('User', backref='respostas_simulados')
    simulado = db.relationship('Simulado', backref='respostas')
    questao = db.relationship('Questao', backref='respostas')
    
    def __init__(self, user_id, simulado_id, questao_id, resposta, acertou, tempo_gasto=None):
